          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: secondColor, borderRadius: BorderRadius.circular(8)),
              child: Padding(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: CircleAvatar(
                        child: Image(
                          image: NetworkImage(
                              'https://ui-avatars.com/api/?name=${userName == null ? 'x' : userName.replaceAll(' ', '+')}&size=256&bold=true&rounded=true'),
                ...
                return Flexible(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      Timestamp timestamp = items[index]['tarih'];
                      var timeToNormal = DateTime.fromMicrosecondsSinceEpoch(
                          timestamp == null
